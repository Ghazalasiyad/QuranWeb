  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white ">
      <nav className="container mx-auto h-[70px] flex justify-between items-center px-6 lg:px-12">
        ...
        {/* Desktop Menu */}
        <ul className="hidden md:flex space-x-10 font-serif text-gray-900 text-[15px] tracking-wider">
          {navLinks.map((link) => (
            <li key={link.name}>
              <NavLink
                to={link.path}
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-white absolute top-[70px] left-0 w-full shadow-md z-40">
